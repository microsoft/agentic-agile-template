...
5. **Fill in all sections:** Prerequisites, Setup (step-by-step for all three layers together), Verification, Known Issues, and Changelog.
...
All commits to this repository should include the Amplifier co-author attribution when generated by an AI agent:
